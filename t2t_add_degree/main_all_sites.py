...
train_index=utils.make_index(20000,20000,0)
np.save('./data/train_index.npy',train_index)
train_index=np.load('./data/train_index.npy')
test_index=utils.make_index(5000,5000,1)
...
idx = np.load('trainindex.npy')
#train_index[0] = idx[0]
#train_index[1] = idx[1]
np.save('trindex.npy',train_index)
np.save('teindex.npy',test_index)

x0_train=x_x0[train_index[0],:,:]
x1_train=x_x0[train_index[1],:,:]
y0_train=x_y0[train_index[0]]
#y0_train = np.load('label.npy')
...
print('x0_testshape:',c_x0.shape)
print('y0_testshape:',x_x0.shape)
print('x0_trainshape:',c_y0.shape)
print('y0_trainshape:',x_y0.shape)
utils.out_map(c_x0,x_x0,c_y0,x_y0,0,model)
